...
(c) Now, fit a linear model that investigates the relationship between `weight` and `habit`. Provide the tidy summary output below.
...
(e) Create an appropriate visualization to compare the the relationship between `age` and `mood`. Your plot should include appropriate labels. 
