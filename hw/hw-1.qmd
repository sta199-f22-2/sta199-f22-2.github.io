...
-   Go to the [sta199-f22-2](https://github.com/sta199-f22-2) organization on GitHub. Click on the repo with the prefix `hw-01`. It contains the starter documents you need to complete the homework assignment.
