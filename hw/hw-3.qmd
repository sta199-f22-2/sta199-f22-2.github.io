...
-   Go to the [sta199-f22-1](https://github.com/sta199-f22-1) organization on GitHub. Click on the repo with the prefix `hw-03`. It contains the starter documents you need to complete the homework assignment.
