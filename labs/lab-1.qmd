...
-   Go to the [**sta199-f22-2**](https://www.github.com/sta199-f22-2) organization on GitHub. Click on the repo with the prefix **lab-1**. It contains the starter documents you need to complete the lab.
