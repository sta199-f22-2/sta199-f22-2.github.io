...
-   Go to the [sta199-fa22-02](github.com/sta199-f22-2) organization on GitHub. Click on the repo with the prefix `lab-03`. It contains the starter documents you need to complete the lab.
...
3.  Create a vector called `countries_of_interest` which contains the names of countries you want to visualize the inflation rates for over the years. For example, if these countries are Türkiye and United States, you can express this as follows:
