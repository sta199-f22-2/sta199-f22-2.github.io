...
::: callout-important
The project peer review is due **at the end of your lab section** on Thursday, Dec 1st. No submission on Gradescope needed, just post issues on GitHub by this time.
:::
...
teams <- read_csv("teams.csv") |> 
  distinct(section, team) 

teams  |>
  group_by(section) |>
  mutate(
    rev_1 = lag(team, default = team[n()]),
