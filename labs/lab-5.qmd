...
We use probabilities all the time when making decisions. *As a group*, provide *two* real world examples of when you use probability to make decisions in your every day life. Think critically. Be creative. 
...
Show your work by writing your answer as a fraction to potentially receive partial credit. For example, if your numerator is the combination of two values, show the addition to obtain these values. Example: (1+4) / 10 = 0.5.
