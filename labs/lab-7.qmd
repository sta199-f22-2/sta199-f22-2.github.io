...
b Now, compare the coefficient associated with `edu` between your new model, and the model fit in Exercise 2. Why are these coefficients different? Justify your answer.
