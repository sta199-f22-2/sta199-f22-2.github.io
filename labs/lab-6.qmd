...
(d) Explain, in your own words, why the width of the SE band changes as we move along the x-axis. 

(e) What do you notice about the prediction (regression) line that may be strange, particularly for very large divergence times?
