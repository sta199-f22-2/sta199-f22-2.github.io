...
::: callout-important
This lab is due Monday 31st at 11:59pm.
:::
...
(b) Visualize the relationship between the two variables. Be sure to put informative axes labels and a title.
...
(b) Then, visualize the relationship between divergence_time and transformed_parsim. Be sure to put informative axes labels and a title. Add a regression line to your visualization.
...
(a) Report the slops for each of these models. Use proper notation. 

(b) To answer our question of interest, would it be useful to compare the slopes in each model to choose the variable that is the strongest predictor of parasite similarity? Why or why not?
...
5. Now, what if calculated  $$R^2$$ to help answer our question? To compare the explanatory power of each individual predictor, we will look at $$R^2$$ between the models. $$R^2$$ is a measure of how much of the variability in the response variable is explained by the model. 
