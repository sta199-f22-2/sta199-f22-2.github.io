...
![](images/STA199.png){width="400" height="400" fig-align="center"}
...
::: {layout="[[100], [50,-10,50]]"}
![](images/Bozeman.png){width="650" height="400" fig-align="center"}
...
![](images/NetflixHighlighted2.png){fig-align="center"}

## 

![](images/DataLiteracy.png){fig-align="center"}
...
::: {#fig-R layout-ncol="2"}
![](images/figure1.png){width="750" height="700"}

![](images/figure2.png){width="750" height="700"}
...
![](images/NHLapp_demo.gif){fig-align="center"}
...
-- R for Data Science by Grolemund & Wickham (2nd ed. O'Reilly) -- Introduction to Modern Statistics by Cetinkaya-Rundel & Hardin (1st ed. OpenIntro)
...
GitHub, Inc., is an Internet hosting service for software development and **version control**. ![](images/pnas.png){fig-align="center"}
