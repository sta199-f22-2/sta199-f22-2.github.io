...
Train your brain. It is week one. We have not started diving deep into what exactly functions do nor are you expected to know at this point. We are getting more comfortable with R and code for now. We will start diving deep into expanding our knowledge of what functions do next week.
...
![](images/02-Meeting-the-toolkit/packages.png){width="900" height="100" fig-align="center"}
...
![](images/02-Meeting-the-toolkit/pull.png){width="400" height="300" fig-align="left"}

## GitHub Commands: Pull Commit Push (Thursday Prep)

![](images/02-Meeting-the-toolkit/commit.png){width="400" height="300" fig-align="left"}

## GitHub Commands: Pull Commit Push (Thursday Prep)

![](images/02-Meeting-the-toolkit/push2.png){width="400" height="300" fig-align="left"}
