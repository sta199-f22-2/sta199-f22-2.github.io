...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1GCwNNWDK0yJPBraWtfZ-tmtXJsgvkLhYTCVtk6c_6js/edit?usp=sharing", sheet = "sec2-elijah")
```
...
d %>%
  ...
  cols_align(
    align = "center", 
    columns = c(week, dow, prepare, slides, ae, hw, hw_sa, lab, lab_sa, exam, project)
    ) %>%
  cols_align(
    align = "left", 
